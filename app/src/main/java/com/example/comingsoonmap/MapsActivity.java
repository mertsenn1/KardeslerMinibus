package com.example.comingsoonmap;
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        locationListener = new LocationListener() {
            ...
            public void onLocationChanged(Location location) {
                ...
                mMap.addMarker(new MarkerOptions().position(userLocation).icon(BitmapDescriptorFactory.fromResource(R.drawable.markericon)));
